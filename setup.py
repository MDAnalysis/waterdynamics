...
short_description = "Analysis of water dynamics in molecular dynamics trajectories and water interactions with other molecules.".strip().split("\n")[0]
...
setup(
    ...
    # url='waterdynamics.readthedocs.io/en/latest/',  # Website
    # platforms=['Linux',
    #            'Mac OS-X',
    #            'Unix',
